CREATE TABLE Products (
    ...
    Description TEXT NVARCHAR(MAX),  -- Optional description, no defined limit
    ...
    OriginalStock INT NOT NULL,  -- Non-negative integer for original stock
    CurrentStock INT NOT NULL,  -- Non-negative integer for current stock
